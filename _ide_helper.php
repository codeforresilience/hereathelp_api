...
namespace {
	...
	class Newrelic extends \Intouch\LaravelNewrelic\Facades\Newrelic{
		 ...
		 * @static 
		 */
		 public static function __construct($throw = false){
			//Method inherited from \Intouch\Newrelic\Newrelic
			 \Intouch\Newrelic\Newrelic::__construct($throw);
		 }
	...
	class Geocoder extends \Toin0u\Geocoder\GeocoderFacade{
		 ...
		 * @static 
		 */
		 public static function __construct($provider = null, $resultFactory = null, $maxResults = 5){
			//Method inherited from \Geocoder\Geocoder
			 \Geocoder\Geocoder::__construct($provider, $resultFactory, $maxResults);
		 }
		 ...
		 */
		 public static function setResultFactory($resultFactory = null){
			//Method inherited from \Geocoder\Geocoder
			 \Geocoder\Geocoder::setResultFactory($resultFactory);
		 }
		 ...
		 */
		 public static function geocode($value){
			//Method inherited from \Geocoder\Geocoder
			 \Geocoder\Geocoder::geocode($value);
		 }
		 ...
		 */
		 public static function reverse($latitude, $longitude){
			//Method inherited from \Geocoder\Geocoder
			 \Geocoder\Geocoder::reverse($latitude, $longitude);
		 }
